...
class Fighter(Character):
    def __init__(self):
        super().__init__(("You have picked Ernest,the fighter"),thaco=20,ac=10,
...
class Cleric(Character):
    def __init__(self):
        super().__init__(("You have selected Mike, the Cleric"),thaco=20,ac=10,
...
class Mage(Character):
    def __init__(self):
        super().__init__(("You have selected Miguel, the wise Mage"),thaco=20,ac=10,
